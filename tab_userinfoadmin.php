...
if ($adminuserlevel == 'ADMINISTRATOR') {
    ...
    <div class="section">
        <?php if ($users->username) { ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="form_userlevel" size="1">
                                    ...
                                    if ($users->userlevel == 'ADMINISTRATOR') {
                                        print 'selected';
                                    }
                                    ?>>ADMINISTRATOR</option>
                                    <option value="SUPERADMIN" <?php
                                    if ($users->userlevel == 'SUPERADMIN') {
                                        print 'selected';
                                    }
                                    ?>>SUPERADMIN</option>
                                </select>
            ...
            ECHO "Either you have a requested a non-existent user or one whose userlevel is his above your ability to edit.";
        }
        ?>
    </div>
    <?php
