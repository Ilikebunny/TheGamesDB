                    ...
                    if (isset($reported->filename)) {
                        ...
                        if (file_exists("../reportedqueue/_cache/$reported->filename")) {
                            ...
                            if (mysql_query("DELETE FROM banners WHERE id=$reportedID")) {
                                ...
                                // Delete files
                                if (file_exists("../banners/$reported->filename")) {
                                    unlink("../banners/$reported->filename");
                                }
                                if (file_exists("../banners/_cache/$reported->filename")) {
                                    unlink("../banners/_cache/$reported->filename");
                                }
                                if (file_exists("../banners/_platformviewcache/$reported->filename")) {
                                    unlink("../banners/_platformviewcache/$reported->filename");
                                }
                                if (file_exists("../banners/_gameviewcache/$reported->filename")) {
                                    unlink("../banners/_gameviewcache/$reported->filename");
                                }
                                if (file_exists("../banners/_favcache/_banner-view/$reported->filename")) {
                                    unlink("../banners/_favcache/_banner-view/$reported->filename");
                                }
                                if (file_exists("../banners/_favcache/_boxart-view/$reported->filename")) {
                                    unlink("../banners/_favcache/_boxart-view/$reported->filename");
                                }
                                if (file_exists("../banners/_favcache/_tile-view/$reported->filename")) {
                                    unlink("../banners/_favcache/_tile-view/$reported->filename");
                                }
