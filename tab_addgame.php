<div id="gameHead">
    ...
    if ($loggedin) {
                ...
                <tr>
                    <td>
                        <p style="font-size: 16px;">
                            <span style="font-weight: bold; color: #CC0000"><img src="<?= $baseurl ?>/images/common/icons/cross_16.png" style="vertical-align: -2px; padding-right: 3px;" />Incorrect: </span>
                            <br />super mario bros.
                    ...
                    <td>
                        <p style="font-size: 16px;">
                            <span style="font-weight: bold; color: #00EA33"><img src="<?= $baseurl ?>/images/common/icons/tick_16.png" style="vertical-align: -2px; padding-right: 3px;" />Correct: </span>
                            <br />Super Mario Bros.
                            <br />Sonic the Hedgehog
                        </p>
                    </td>
        ...
        <div id="addGamePanel" style="width: 600px; background-color: #000; color: #FFF; margin: 40px auto 20px auto; border: 1px solid #666; border-radius: 15px; padding: 5px 0px 15px 0px; font-size: 1.3em;">
            ...
            <form action="<?php echo $baseurl; ?>/index.php?" method="POST" onsubmit="if ($('#GameTitle').val() != '' && $('#Platform').val() != 'empty' && $('#existsNo').attr('checked') == 'checked') {
                        return true;
                    } else {
                        return false;
                    }">
                <table align="center">
                        ...
                        <td>
                            <select id="Platform" name="cleanPlatform" style="font-size: 1.2em; width: 355px; margin: 5px; padding: 2px;">
                                ...
                                while ($platformRow = mysql_fetch_assoc($platformResult)) {
                                    ?>
                                    <option value="<?php echo $platformRow["id"]; ?>"<?php
                                    if ($passPlatform == $platformRow["id"]) {
                                        echo " selected";
                                    }
                                    ?>><?php echo $platformRow["name"]; ?></option>
                                            <?php
                                        }
                                        ?>
                            </select>
                    ...
                    <tr> 
                        ...
                        <td>
                            <input type="text" id="GameTitle" name="GameTitle" placeholder="Enter Game Title..." autocomplete="off" style="font-size: 1.2em; width: 351px; margin: 5px; padding: 2px;" value="<?php
                            if (!empty($passTitle)) {
                                echo $passTitle;
                            }
                            ?>">
