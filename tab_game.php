    ...
    <div id="gameTitle">
        ...
        <span id ="gameUserLinks">
            <?php if ($loggedin == 1) { ?>
                ...
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <?php
                ## First, generate their userfavorites array
    ...
    <div id="gameCoversWrapper">
        ...
        <div id="gameCovers">
            ...
            if ($frontCoverResult = mysql_query(" SELECT b.id, b.filename FROM banners as b WHERE b.keyvalue = '$game->id' AND b.filename LIKE '%boxart%front%' LIMIT 1 ")) {
                ...
                if (!empty($front)) {
                    ?>
                    <img id="frontCover" class="frontCover imgShadow" <?= imageResize2("$baseurl/banners/$front->filename", "banners/_gameviewcache/$front->filename", 300, "width") ?> alt="<?php echo $game->GameTitle; ?>" title="<?php echo $game->GameTitle; ?>" />
                    <?php
                    if ($backCoverResult = mysql_query(" SELECT b.id, b.filename FROM banners as b WHERE b.keyvalue = '$game->id' AND b.filename LIKE '%boxart%back%' LIMIT 1 ")) {
                        ...
                        if (!empty($back)) {
                            ?>
                            <img  id="backCover" class="backCover imgShadow" style="display: none;" <?= imageResize2("$baseurl/banners/$back->filename", "banners/_gameviewcache/$back->filename", 300, "width") ?> alt="<?php echo $game->GameTitle; ?>" title="<?php echo $game->GameTitle; ?>" />
                            <?php
                        }
                    }
                } else {
    ...
    <div id="gameInfo">
        ...
        <h2>
            <img src="<?php echo $baseurl; ?>/images/common/consoles/png32/<?php echo $game->PlatformIcon; ?>" alt="<?php echo $game->PlatformName; ?>" title="<?php echo $game->PlatformName; ?>" style="vertical-align: -8px;" />&nbsp;<?php if (!empty($game->PlatformName)) { ?>
                <a style="color: #fff;" href="<?= $baseurl ?>/platform/<?php
        ...
        <div id="gameVitals">
            ...
            <p>
                <span class="grey">Players:</span>&nbsp;&nbsp;<?php
                ...
                ?>
                <span class="grey" style="padding-left: 20px;">Co-op:</span>&nbsp;&nbsp;<?php
                if ($game->coop != false) {
                    echo $game->coop;
                } else {
                    echo "N/A";
                ...
                ?><br />
                <span class="grey">Genres:</span>&nbsp;&nbsp;<?php
                if (!empty($game->Genre)) {
