...
<div id="gameHead">
    ...
    <div class="links">
        ...
        <p>&nbsp;</p>
        <h2 style="text-align: center; color: #FF4F00;"><?= $title ?> <?= $max ?> Most Recent <?php if ($bannertype == "series") {
    echo "Banner";
} elseif ($bannertype == "clearlogo") {
    echo "ClearLOGO";
} else {
    echo ucwords($bannertype);
} ?> Images <?= $extratitle ?></h2>
        <p>&nbsp;</p>
